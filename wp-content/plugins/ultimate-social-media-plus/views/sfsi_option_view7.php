...
<div class="row">
	...
	<div class="pop_up_show">
		...
		<div class="field" style="width:50%">
            ...
            <?php  _e( 'Please hold the the CTRL key to select multiple pages', SFSI_PLUS_DOMAIN ); ?>.
        </div>
	</div>
</div>
<div class="row">
	...
	<div class="pop_up_show">
        ...
        <label>
            <?php  _e( 'Every time the user scrolls to the end of the page', SFSI_PLUS_DOMAIN ); ?>
        </label>
    </div> 
...
<!-- 	    <div class="sfsi_plus_prem_show">
	        <p class=sfsi_plus_prem_plu_desc>
	            ...
	            <?php  _e( 'The Premium Plugin also it allows you to show the pop-up when the user tries to leave your page. Also, you can limit how often the pop-up is shown to the same the user (e.g. only once per day) ', SFSI_PLUS_DOMAIN ); ?>
		...
		<div class ="sfsi_plus_new_prmium_follw">
			...
			<p>
				<b><?php  _e( 'New: ', SFSI_PLUS_DOMAIN ); ?></b>
				<?php  _e( 'The Premium Plugin also it allows you to show the pop-up when  the user tries to leave your page. Also, you can limit how often the pop-up is shown to the same the user (e.g. only once per day) ', SFSI_PLUS_DOMAIN ); ?>
				<br>- &nbsp;&nbsp;<?php  _e( 'Show it when the users try to leave your page', SFSI_PLUS_DOMAIN ); ?>
				<br>- &nbsp;&nbsp;<?php  _e( 'Limit how often the pop-up is shown to the same the user (e.g. only once per day)', SFSI_PLUS_DOMAIN ); ?>
				<br>- &nbsp;&nbsp;<?php  _e( 'Select to show the subscription form in the pop-up (which you designed in question 8)', SFSI_PLUS_DOMAIN ); ?>
				<br>
				<a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  class="sfisi_plus_font_bold" target="_blank"><?php _e( 'Go premium now', SFSI_PLUS_DOMAIN); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=more_popup_options&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more', SFSI_PLUS_DOMAIN); ?></a>
			</p>	        	
		</div>
