		...
		<li class="row sfsiplus_show_via_onhover  disabled_checkbox">
			...
			<div class="sfsiplus_right_info">
				...
				<p style="display:block">
					<span class="sfsiplus_toglepstpgspn" style="display:inline-block">Show a Pinterest icon over images on mouse-over </span> <span><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmi_settings_page&utm_campaign=pinterest_icon_mouse_over&utm_medium=link" target="_blank" style="font-weight:800;color:#777">Premium feature</a></span>
				</p>
