...
<div class="wapper sfsi_mainContainer">
    ...
    <div class="main_contant">
        ...
        <div class="welcometext">
           ...
           <p><?php _e('Simply answer the questions below (at least the first 3) - that\'s it! Start by clicking on them.', SFSI_PLUS_DOMAIN); ?></p>

            <p><a style="text-decoration: none;" href="javascript:void(0)"><?php _e('New:', SFSI_PLUS_DOMAIN); ?> </a><?php _e('Our new Premium Plugin it allows many more placement options, better sharing features (e.g. define which text &amp; images will get shared), optimization for mobile, <a class="sfsi_plus_font_inherit" target="_blank" href="https://www.ultimatelysocial.com/extra-icon-style/">more icon design styles</a>, <a class="sfsi_plus_font_inherit" target="_blank" href="https://www.ultimatelysocial.com/animated-social-media-icons/">animated icons</a>, <a class="sfsi_plus_font_inherit" target="_blank" href="https://www.ultimatelysocial.com/themed-icons-search/">themed icons</a>, and <a class="sfsi_plus_font_inherit" href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=notification_banner&utm_medium=banner" target="_blank">much more</a>.', SFSI_PLUS_DOMAIN); ?>
